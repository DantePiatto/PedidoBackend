...
using Delivery.Application.Parametros.DeleteParametros;
using Delivery.Application.Parametros.DesactiveParametros;
using Delivery.Application.Parametros.GetByIdParametro;
using Delivery.Application.Parametros.GetParametroByPagination;
using Delivery.Application.Parametros.GetSubnivelesById;
using Delivery.Application.Parametros.RegisterParametros;
using Delivery.Application.Parametros.UpdateParametros;
using Delivery.Domain.Abstractions;
using Delivery.Domain.Parametros;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
namespace Delivery.Api.Controllers.Parametros;
