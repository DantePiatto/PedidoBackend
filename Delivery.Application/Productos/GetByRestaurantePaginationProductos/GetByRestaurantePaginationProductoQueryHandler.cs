...
internal sealed class GetByRestaurantePaginationProductoQueryHandler : IQueryHandler<GetByRestaurantePaginationProductoQuery, PagedResults<ProductoDto>?>
{
    ...
    public GetByRestaurantePaginationProductoQueryHandler(
    ...
    public async Task<Result<PagedResults<ProductoDto>?>> Handle(GetByRestaurantePaginationProductoQuery request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(request.RestauranteId))
            {
                predicateB = predicateB.And(op => op.RestauranteId! == new RestauranteId(Guid.Parse(request.RestauranteId)));
            }
